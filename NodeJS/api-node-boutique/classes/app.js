...
export class App {
    ...
    read() {
        try {
            ...
            console.error(`Erreur de lecture du fichier ${this.fileClient}: ${err.message}`);
        }
        ...
        try {
            ...
            console.error(`Erreur de lecture du fichier ${this.fileProduit}: ${err.message}`);
        }
        ...
        try {
            ...
            console.error(`Erreur de lecture du fichier ${this.fileCommande}: ${err.message}`);
        }
    }
